...
const navLinks = [
  ...
  { to: "/aisa-giss-2026", label: "AISA GISS 2026" },
  { to: "/development", label: "Tech" },
  { to: "/developer", label: "About" },
        ...
        <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-6 px-5 sm:px-8">
          ...
          <div className="flex items-center gap-2">
            <Button size="sm" asChild>
              <Link to={isLoggedIn ? "/helpboard" : "/login"}>
            ...
            <button
              ...
              className="flex size-9 items-center justify-center rounded-control text-chalk-2 transition-colors hover:bg-notice hover:text-chalk md:hidden"
            >
              {menuOpen ? (
