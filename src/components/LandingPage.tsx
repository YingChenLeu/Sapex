...
/* BRIDGE is a real acronym the initiative holds itself to, so the letters
   carry meaning. This is not decorative numbering. */
...
/* A parallel set, not a sequence — so it is set as an index, unnumbered. */
const INDEX = [
  {
...
const SHOWCASES = [
  {
    ...
    copy: "Post a question and verified peers from your school jump in — math notation, mentions, and all.",
  ...
  },
  {
    ...
    copy: "Pick a field, grab a prompt, and post what you’re making so the rest of your school can see it.",
    Demo: OriginsLabDemo,
    note: null,
  },
  {
...
const FOOTER_LINKS = [
  {
    ...
    links: [
      { label: "Academic Center", to: "/helpboard" },
      { label: "Study Rooms", to: "/study-rooms" },
      { label: "Origins Lab", to: "/origins-lab" },
      { label: "Wellness Support", to: "/wellness-support" },
    ],
  },
  {
    ...
    links: [
      ...
      { label: "AISA GISS 2026", to: "/aisa-giss-2026" },
  ...
  },
  {
    ...
    links: [
      { label: "Tech stack", to: "/development" },
...
function LandingPage() {
  return (
    <div className="landing flex min-h-screen flex-col bg-transparent text-chalk">
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          <div className="ruled">
            ...
            <div className="ruled-body">
              {/* The orb column needs a definite width: an `auto` track plus a
                  `w-full` child collapses the track to zero. */}
              <div className="grid items-center gap-14 lg:grid-cols-[minmax(0,1fr)_360px] lg:gap-20">
                <div>
                  ...
                  >
                    Nobody should have to figure school out alone.
                  </motion.h1>
                  ...
                  <motion.p
                    ...
                    variants={fadeUp}
                  >
                    Post what you’re stuck on and someone from your school
                    picks it up. Same for the days when it isn’t the
                    schoolwork that’s hard.
                  </motion.p>
                  ...
                  <motion.p
                    ...
                    variants={fadeUp}
                  >
                    Funded by AISCT. Used by the AISCT Social Science
                    department.
                  </motion.p>
                </div>

                {/* The loud moment: MetaBalls + CircularText, untouched. */}
                <motion.div
                ...
                >
                  {/* The metaballs are dark teal, so they read as silhouettes
                      against a lit ground rather than as lit shapes. The disc
                      stays translucent and sits on a soft glow so they have
      ...
      {/* ================================================================= */}
      {/* Index — the five places, as a list because they are parallel      */}
      {/* ================================================================= */}
      ...
      {/* ================================================================= */}
      {/* Purpose — over the MemoriesBento photo marquee                    */}
      {/* ================================================================= */}
      <section
        id="about"
          ...
          >
            ...
            <div className="ruled-body">
              ...
              <p className="measure mt-6 text-[15px] leading-relaxed text-chalk-2">
                We wanted somewhere to get help with the work and look out for
                each other, without it feeling like an institution. You’re only
                ever talking to people from your own school, so it stays real
                and safe.
              </p>
            </div>
          </motion.div>
      ...
      {/* ================================================================= */}
      {/* Product — five animated demos, constant spine alignment           */}
      {/* ================================================================= */}
      <section
        id="product"
      ...
      {/* ================================================================= */}
      {/* BRIDGE — over the SoftAurora shader                               */}
      {/* ================================================================= */}
      <section
        id="bridge"
      ...
      <section className="border-t border-rule">
        <div className="mx-auto max-w-6xl px-5 py-24 sm:px-8">
          <div className="ruled">
            <div className="ruled-margin">bring it to your school</div>
            <div className="ruled-body">
              <h2 className="display-2 measure text-chalk">
                We onboard one school at a time.
              </h2>
              <p className="measure mt-6 text-[15px] leading-relaxed text-chalk-2">
                That’s how every space stays verified, so students only ever
                meet people they actually go to school with. Tell us about
                yours.
              </p>
              <div className="mt-10 flex flex-wrap items-center gap-5">
                ...
                <Button asChild variant="link" size="lg" className="px-0">
                  <Link to="/initiative">Read why we started</Link>
                </Button>
              </div>
            </div>
          </div>
      ...
      <footer id="social" className="border-t border-rule">
        <div className="mx-auto max-w-6xl px-5 py-14 sm:px-8">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
            <div>
              ...
              <p className="mt-4 max-w-[34ch] text-[13px] leading-relaxed text-chalk-3">
                A student collaboration platform for academic help, wellness
          ...
          <p className="mt-12 border-t border-rule pt-6 text-[12px] text-chalk-3">
            © {new Date().getFullYear()} Sapex Global Initiative. Funded by
            AISCT in Cape Town.
          </p>
        </div>
      </footer>
